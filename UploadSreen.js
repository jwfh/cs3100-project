...
/*
  ...
  Parameters: event
  Usage:This fxn is handler of submit button which is responsibe for handling file uploads
  to backend
*/
handleClick(event){
...
handleLogout(event){
  ...
  var loginPage =[];
  loginPage.push(<LoginPage appContext={this.props.appContext}/>);
  this.props.appContext.setState({loginPage:loginPage,uploadPage:[]})
}
  render() {
    return (
      <div className="App">
